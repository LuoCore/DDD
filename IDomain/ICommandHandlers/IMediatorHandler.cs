...
namespace Domain.Interface.ICommandHandlers
{
    /// <summary>
    /// 中介处理程序接口
    /// 可以定义多个处理程序
    ...
    public interface IMediatorHandler
    {
        ...
        /// <returns></returns>
        Task SendCommand<T>(T command) where T :ICommands.ICommand;
        ...
        /// <returns></returns>
        Task RaiseEvent<T>(T @event) where T : IEvents.IEventBase;
    }
}
