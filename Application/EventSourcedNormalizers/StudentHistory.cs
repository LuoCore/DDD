...
namespace Application.EventSourcedNormalizers
{
    ...
    public class StudentHistory
    {
        ...
        // 将数据从事件源中获取到list中
        public static IList<StudentHistoryData> ToJavaScriptStudentHistory(IList<Domain.Interface.IEvents.IEventStore> storedEvents)
        {
        ...
        private static void StudentHistoryDeserializer(IEnumerable<Domain.Interface.IEvents.IEventStore> storedEvents)
        {
